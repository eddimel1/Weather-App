...
export const DailyForeCast = () => {
  ...
  const {weatherData, setWeatherDataByTown, setWeatherDataByCoords, error} =
    UsefetchWeatherData()
                  ...
                  <div className={classes.weatherDataContainer}>
                    <div className={classes.timeAndDataContainer}>
                      <div className={classes.time}>
                        {`${getDatefromData('hours')} : ${getDatefromData(
                          'minutes'
                        )}`}{' '}
                        PM
                      </div>
                    ...
                    <div className={classes.weatherData}>
                      ...
                      <div className={classes.weatherDataItem}>
                        Pressure :{' '}
                        {weatherData?.daily
                          ? weatherData.daily[0].pressure + ' Hpa'
                          : ''}
                      </div>
                      <div className={classes.weatherDataItem}>
                        Day :{' '}
                      ...
                      <div className={classes.weatherDataItem}>
                        Wind :{' '}
                        {weatherData?.daily
                          ? weatherData.daily[0].wind_speed + 'm/s'
                          : ''}
                      </div>
                    </div>
                  </div>
                ...
                <div className={classes.dailyBottomCurrentForeCast}>
                  <div className={classes.dailyBottomCurrentForeCastContainer}>
                    <div className={classes.currentDay}>
                      {weatherData?.daily
                        ? Days[
                            new Date(weatherData.daily[0].dt * 1000).getDay()
                          ]
                        : ''}{' '}
                    </div>
