...
export type actionType =  'prepare'  | 'chooseAnswer' | 'nextQuestion' | 'restart' | 'chooseOptions' | 'start' | 'scored' 
export type actions = {
    type: actionType,
    payload? : any
}
export const quizzReducer = (state:quizzState,action:actions) : quizzState => {
     switch (action.type) {
         case 'prepare':
             ...
             case 'restart':
                ...
                case 'start':
                return {...state, gameState : 'started' , difficulty:action.payload.difficulty , category : action.payload.category
            }
            case 'scored':
            ...
            case 'chooseAnswer':
             ...
             case 'chooseOptions':
                return {...state, category : action.payload.category , difficulty : action.payload.difficulty}
