...
import {celsiusFrom , KelvinFrom , fahrenheitFrom ,rankineFrom , converterArrayReturnType}  from '../../utils/converterUtils'
...
<div className={classes.converterWrapper}>
          ...
          <ConverterBox setSelected={setSelectedFrom} selected={selectedFrom} setInputInfo ={setInputInfoFrom} calculatedValue = {calculatedValueFrom} amount={amountFrom} 
          setCalculated ={setCalculatedValueFrom}
          />
          <ConverterBox setSelected={setSelectedTo} selected={selectedTo} setInputInfo ={setInputInfoTo} calculatedValue={calculatedValueTo}  amount={amountTo}
