...
export const Ctx = createContext<{state : stateType , dispatch : React.Dispatch<any>}>({state:{mode:'normalmode'} , dispatch : () => null})
...
export const CtxProvider:FC = ({children}) => {
    ...
    return <Ctx.Provider value={{state:state , dispatch}}>{children}</Ctx.Provider>
