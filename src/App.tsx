...
function App() {
    ...
    const [randomColor , setRandomColor] = useState('linear-gradient(90deg, rgba(6,38,241,1) 0%, rgba(26,9,121,1) 50%, rgba(0,212,255,1) 100%)')
    useEffect(()=>{
  ...
  return (
    ...
    <Buttons mode={mode} setMode={setModewithUseCallback}/>
      <Routes>
            <Route path='/' element={<Transition><MainContainer/></Transition> }  > </Route>
            <Route path='/graphs' element={<Transition><Graphs/></Transition>} > </Route>
            <Route path='daily' element={<Transition><DailyForeCast/></Transition>}></Route>
            <Route path='calc' element={<Transition><Calculator/></Transition>}></Route>
            <Route path='converter' element={<Transition><Converter1/></Transition>}></Route>
            <Route path='airPolutionArticle' element={<Transition><Article1/></Transition>}></Route>
            <Route path='airpolution' element={<Transition><AirPolutionForecast/></Transition>}></Route>
            <Route path='natureGalery' element={<Transition><NatureGalery/></Transition>}></Route>
            <Route path='quizz' element={<Transition><GameConductor /></Transition>}></Route>
