...
export const PolutionCompTable = (props : {comps: compType , timeOfTheDay : string} ) => {
  ...
  return (
    <div className={classes.day}>
                    <h1 className={classes.timeOfTheDay}>{props.timeOfTheDay}</h1>
                     <div className={classes.compItem} style={{borderBottom :  ` 3px solid ${decideColor('co' , props.comps.co)}`}}> CO :   {props.comps.co} μg/m3</div>
            <div className={classes.compItem}style={{borderBottom :  ` 3px solid ${decideColor('nh3' , props.comps.nh3)}`}} >NH3 :   {props.comps.nh3} μg/m3</div>
            {/* <div className={classes.compItem}>NO :    {props.comps.no} μg/m3</div> */}
            <div className={classes.compItem} style={{borderBottom :  ` 3px solid ${decideColor('no2' , props.comps.no2)}`}}>NO2 :   {props.comps.no2} μg/m3</div>
            <div className={classes.compItem}style={{borderBottom :  ` 3px solid ${decideColor('o3' , props.comps.o3)}`}}>O3 :    {props.comps.o3} μg/m3</div>
            <div className={classes.compItem} style={{borderBottom :  ` 3px solid ${decideColor('pm10' , props.comps.pm10)}`}}>PM10 :  {props.comps.pm10} μg/m3</div>
            <div className={classes.compItem}style={{borderBottom :  ` 3px solid ${decideColor('pm25' , props.comps.pm2_5)}`}}>PM25 :  {props.comps.pm2_5} μg/m3</div>
            <div className={classes.compItem}style={{borderBottom :  ` 3px solid ${decideColor('so2' , props.comps.so2)}`}}>SO2 :   {props.comps.so2} μg/m3</div>
                </div>
  )
}
